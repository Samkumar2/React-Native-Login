...
export default function LoginScreen() {
  ...
  return (
    <View style={{ backgroundColor: 'white',height:"100%",width:"100%" }}>
      ...
      <View style={{  backgroundColor:"transparent",flex: 1, justifyContent: "space-evenly",paddingTop:70,paddingBottom:10 }}>
        ...
        >
          ...
          <Animated.View entering={FadeInDown.duration(1000).springify().damping(3)}
           style={{ marginTop: 8, flexDirection: "row" }}>
            <Text style={{ padding: 2 }}>Don't have an account ?</Text>
